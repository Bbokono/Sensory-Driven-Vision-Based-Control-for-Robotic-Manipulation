# MPC and Obstacle Avoidance Execution Task

This document outlines the steps to run the simulation with Obstacle Avoidance enabled and the environment prepared for Model Predictive Control (MPC).
...
Open 5 separate terminal windows. In each terminal, first connect to the container:
